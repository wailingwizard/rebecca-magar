                    ...
                    <div class="row border-bottom pad">
                        ...
                        <div class="col-sm-6">
                            ...
                            <ol>
                                ...
                                <li>Competitor apps that historically supported GPU overclocking and lighting control for GPU's across manufacturers are reported to be in trouble (due to funding issues and user complaints), presenting an opportunity for more user interest in manufacturer-specific software.</li>
                                <li>Gamers prefer using apps in dark mode and show a preference for red and RGB color schemes.</li>
                                <li>The ability to save multiple lighting profiles and easily switch between them is a key feature gamers look for in a GPU lighting app.</li>
                            </ol>
                        </div>
                    </div>
                </div>
